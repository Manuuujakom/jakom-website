// src/pages/VirtualAssistance.js
  ...
  return (
    <div className="min-h-screen bg-[#0A1128] text-[#F8F8F8] flex flex-col items-center justify-center py-16 px-6">
      ...
      <p className="text-xl md:text-2xl text-[#CCD2E3] max-w-3xl text-center leading-relaxed mb-12">
        This is the Virtual Assistance page. We provide professional support to streamline your operations.
      </p>
      <img src="https://placehold.co/600x400/CCD2E3/0A1128?text=Virtual+Assistance" alt="Virtual Assistance" className="rounded-xl shadow-lg mb-8" />
      <a
        href="/contact-us"
