  ...
  return (
    <div className="min-h-screen bg-[#0A1128] text-[#F8F8F8] flex flex-col items-center justify-center py-16 px-6">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 w-full max-w-2xl">
        <div className="bg-[#1A2542] p-8 rounded-xl shadow-lg border border-[#C9B072] flex flex-col items-center text-center w-full md:w-1/3">
          <Mail size={48} className="text-[#4CAF50] mb-4" />
          <h2 className="text-2xl font-bold text-[#F8F8F8] mb-2">Email</h2>
          <a href="mailto:emmanuelomondiobare@gmail.com" className="text-[#CCD2E3] hover:text-[#C9B072] transition duration-300">
        ...
        <div className="bg-[#1A2542] p-8 rounded-xl shadow-lg border border-[#C9B072] flex flex-col items-center text-center w-full md:w-1/3">
          ...
          <a href="tel:+254794255000" className="text-[#CCD2E3] hover:text-[#C9B072] transition duration-300">
            +254 794 255000
          </a>
        </div>
        <div className="bg-[#1A2542] p-8 rounded-xl shadow-lg border border-[#C9B072] flex flex-col items-center text-center w-full md:w-1/3">
